...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 73.0, 215.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 71.0, 253.0, 65.0, 20.0 ],
					"text" : "qmetro 24"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 964.0, 351.0, 254.0, 47.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 828.0, 485.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.245728, 177.746246, 98.0, 20.0 ],
					"text" : "r ---toFeedrTime",
...
,
					"patching_rect" : [ 998.745728, 230.746246, 88.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 998.745728, 204.818817, 79.0, 20.0 ],
					"text" : "r ---fromNote",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 883.745728, 262.0, 90.0, 20.0 ],
					"text" : "r ---toFeedrMix",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 818.745728, 177.746246, 100.0, 23.0 ],
					"prefix" : "dim",
					"prefix_mode" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 998.745728, 262.0, 89.0, 20.0 ],
					"rounded" : 3
				}
...
,
					"patching_rect" : [ 808.745728, 301.0, 244.0, 18.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontface" : 0,
						"digest" : "",
...
,
					"patching_rect" : [ 798.245728, 204.818817, 141.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontface" : 0,
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 920.245728, 177.746246, 55.0, 21.0 ],
					"varname" : "delayframe"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 574.0, 240.0, 50.0, 18.0 ],
					"text" : "9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 247.0, 50.0, 18.0 ],
					"text" : "49"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 591.0, 362.0, 50.0, 18.0 ],
					"text" : "39"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 458.5, 197.0, 20.0, 20.0 ],
					"text" : "t i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 515.5, 287.0, 32.5, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 515.5, 234.0, 32.5, 20.0 ],
					"presentation_rect" : [ 518.0, 237.0, 0.0, 0.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 515.5, 337.0, 32.5, 20.0 ],
					"text" : "%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 257.0, 197.0, 71.0, 20.0 ],
					"text" : "route count"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 483.0, 287.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 483.0, 234.0, 32.5, 20.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 483.0, 157.0, 73.0, 20.0 ],
					"text" : "sel 106 107"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.5, 96.0, 50.0, 18.0 ],
					"text" : "116"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 483.0, 96.0, 59.5, 20.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 157.5, 211.5, 50.0, 20.0 ],
					"text" : "t bang l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 157.5, 297.0, 80.0, 60.0 ]
				}
...
,
					"patching_rect" : [ 58.0, 128.0, 75.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontface" : 0,
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.5, 191.5, 82.0, 20.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 157.5, 246.397827, 68.0, 18.0 ],
					"text" : "jit.qt.movie"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 58.0, 158.5, 218.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 128.5, 50.0, 18.0 ],
					"text" : "count"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 807.745728, 242.5, 968.245728, 242.5 ],
					"source" : [ "obj-115", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 818.245728, 330.04834, 791.185486, 330.04834, 791.185486, 194.0, 807.745728, 194.0 ],
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 266.5, 322.5, 538.5, 322.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 525.0, 366.0, 18.25, 366.0, 18.25, 148.5, 67.5, 148.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 868.745728, 194.782532, 868.745728, 194.782532 ],
					"source" : [ "obj-43", 1 ]
				}
